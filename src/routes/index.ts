...
router.use('/users', auth, logUserActivity, usersRouter);
router.use('/exercises', exsRouter);
router.use('/sentences', auth, logUserActivity, sentencesRouter);
router.use('/topics', auth, logUserActivity, topicsRouter);
